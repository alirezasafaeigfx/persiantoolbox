      ...
      <Container className="space-y-8 py-10 md:py-12">
        <header className="section-surface relative overflow-hidden p-6 md:p-10">
          ...
          <div className="relative space-y-5">
            <span className="inline-flex items-center rounded-full border border-(--border-light) bg-(--surface-2) px-4 py-1.5 text-xs font-semibold text-(--text-muted)">
              Alireza Safaei | Web Systems Engineering
            </span>
            <h1 className="text-4xl font-black leading-tight text-(--text-primary) md:text-5xl">
        ...
        <section className="section-surface p-6 md:p-8">
          <h2 className="text-2xl font-black text-(--text-primary)">درباره علیرضا صفایی</h2>
