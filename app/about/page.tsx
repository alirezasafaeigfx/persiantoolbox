  ...
  return (
    <SiteShell containerClassName="py-10 space-y-8">
      <header className="section-surface p-6 md:p-8 space-y-3">
        <h1 className="text-3xl font-black text-(--text-primary)">درباره جعبه ابزار فارسی</h1>
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">چرا جعبه ابزار فارسی؟</h2>
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">اصول محصول</h2>
        <ul className="grid gap-3 md:grid-cols-3">
          <li className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 text-sm text-(--text-secondary) leading-7">
            <span className="font-semibold text-(--text-primary)">🔒 اولویت حریم خصوصی</span>
            <p className="mt-2">
          ...
          <li className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 text-sm text-(--text-secondary) leading-7">
            <span className="font-semibold text-(--text-primary)">⚡ سرعت و عملکرد</span>
            <p className="mt-2">
          ...
          <li className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 text-sm text-(--text-secondary) leading-7">
            <span className="font-semibold text-(--text-primary)">📱 تجربه یکدست</span>
            <p className="mt-2">
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">ابزارها و امکانات</h2>
        <p className="text-sm text-(--text-secondary) leading-7">
        ...
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div className="text-sm font-bold text-primary">💰 ابزارهای مالی</div>
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">📄 ابزارهای PDF</div>
            <div className="text-xs text-(--text-muted) mt-1">
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">🖼️ ابزارهای تصویر</div>
            <div className="text-xs text-(--text-muted) mt-1">فشرده‌سازی، تغییر اندازه و OCR</div>
          </Link>
          <Link
            href="/date-tools"
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">📅 ابزارهای تاریخ</div>
            <div className="text-xs text-(--text-muted) mt-1">تبدیل تاریخ شمسی، میلادی و قمری</div>
          </Link>
          <Link
            href="/text-tools"
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">✏️ ابزارهای متنی</div>
            <div className="text-xs text-(--text-muted) mt-1">
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">🔐 ابزارهای اعتبارسنجی</div>
            <div className="text-xs text-(--text-muted) mt-1">
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">🧾 ابزارهای کسب‌وکار</div>
            <div className="text-xs text-(--text-muted) mt-1">فاکتورساز، رسیدساز و پیش‌فاکتور</div>
          </Link>
          <Link
            href="/career-tools"
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">📄 ابزارهای شغلی</div>
            <div className="text-xs text-(--text-muted) mt-1">
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">✏️ ابزارهای نگارش</div>
            <div className="text-xs text-(--text-muted) mt-1">
          ...
          <Link
            ...
            className="rounded-md border border-(--border-light) bg-(--surface-1) p-4 hover:border-primary transition-colors"
          >
            <div className="text-sm font-bold text-primary">📝 ابزارهای قرارداد</div>
            <div className="text-xs text-(--text-muted) mt-1">
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">آمار عملکرد</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {performanceStats.map((item) => (
            <div
              key={item.label}
              className="text-center p-4 rounded-md border border-(--border-light) bg-(--surface-1)"
            >
              <div className="text-2xl font-black text-primary">{item.number}</div>
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">توسعه‌دهنده</h2>
        <p className="text-sm text-(--text-secondary) leading-7">
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">شفافیت</h2>
        <p className="text-sm text-(--text-secondary) leading-7">
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">محدودیت‌ها</h2>
        <p className="text-sm text-(--text-secondary) leading-7">
      ...
      <section className="section-surface p-6 md:p-8 space-y-4">
        <h2 className="text-xl font-bold text-(--text-primary)">ارتباط با ما</h2>
        <p className="text-sm text-(--text-secondary) leading-7">
