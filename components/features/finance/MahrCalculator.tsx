      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label htmlFor="mahr-previous-year-index" className="text-sm text-[var(--text-muted)]">
        ...
        {result ? (
          ...
          >
            ...
            <div className="rounded-[var(--radius-md)] bg-[var(--bg-subtle)] p-3 text-xs text-[var(--text-muted)]">
              ⚠️ این محاسبه صرفاً جهت اطلاع‌رسانی است و جایگزین نظر مرجع قضایی یا مشاوره حقوقی
              نیست.
            </div>
            <ShareResult
