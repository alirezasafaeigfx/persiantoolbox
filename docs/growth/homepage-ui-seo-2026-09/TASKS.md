...
| --- | --- | --- | --- | --- |
| PT-00 | checkout ایزوله و ثبت baseline | ندارد | READY | SHA، وضعیت محلی، screenshots و گزارش مبنا |
| PT-01 | schema و ادعاهای حریم خصوصی | PT-00 | READY | تست رفتاری schema، copy همسان، لینک صحیح برند |
| PT-02 | هیرو و کارت‌های صفحه اصلی | PT-00 | READY | قبل/بعد روشن و تاریک، جستجو/CTA سالم |
| PT-03 | آزمون یکپارچه و آماده‌سازی PR | PT-01، PT-02 | READY | QA، build، smoke، E2E، گزارش نهایی |
