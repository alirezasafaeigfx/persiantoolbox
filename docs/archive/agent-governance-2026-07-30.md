...
Superseded by the root AGENTS.md. Operational details below are historical and must not be used to override the current deployment safety contract.
...
- Individual contributors must review [`docs/licensing/cla-individual.md`](../licensing/cla-individual.md).
- Corporate contributors must review [`docs/licensing/cla-corporate.md`](../licensing/cla-corporate.md).
