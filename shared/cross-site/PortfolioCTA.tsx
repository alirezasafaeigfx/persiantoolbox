...
export function PortfolioCTA({ variant, toolId, className = '' }: PortfolioCTAProps) {
  ...
  const content = {
    footer: {
      ...
      style:
        'bg-linear-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700',
    },
    'tool-result': {
      Icon: IconLightbulb,
      ...
      style:
        'bg-linear-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 border border-blue-200 dark:border-blue-800',
    },
    'premium-gate': {
      Icon: IconZap,
      ...
      style:
        'bg-linear-to-r from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950 border border-amber-200 dark:border-amber-800',
    },
    sidebar: {
      Icon: IconCode,
      ...
      style:
        'bg-linear-to-r from-green-50 to-teal-50 dark:from-green-950 dark:to-teal-950 border border-green-200 dark:border-green-800',
    },
  }[variant];
  ...
  return (
    <Link
      href={content.href}
      onClick={handleClick}
      className={`block p-4 rounded-lg hover:shadow-medium transition-all ${content.style} ${className}`}
      target="_blank"
      rel="noopener noreferrer"
    >
      <div className="flex items-center gap-3">
        <content.Icon className="w-6 h-6 text-(--text-muted)" />
