...
const rawToolsRegistry: RawToolEntry[] = [
  ...
  },
  {
    ...
    description:
      'محاسبه حقوق خالص ۱۴۰۵ با بیمه، مالیات و مزایا. تبدیل ناخالص↔خالص، محاسبه معکوس، جدول کسورات کامل. رایگان، آفلاین، بدون ثبت‌نام.',
    keywords: [
      'محاسبه حقوق',
      'محاسبه خالص حقوق',
      'حقوق ۱۴۰۵',
    ...
    content: {
      ...
      sections: [
        ...
        {
          heading: 'محاسبه سنوات و پایان خدمت',
          paragraphs: [
            'سنوات پایان خدمت بر اساس آخرین حقوق پایه و مزایای مستمر محاسبه می‌شود. این مبلغ نقش مهمی در تصمیم‌گیری مالی در زمان ترک کار یا بازنشستگی دارد.',
            'با استفاده از خروجی این ابزار می‌توانید مبلغ تقریبی سنوات خود را برآورد کنید و آن را در برنامه‌ریزی مالی لحاظ نمایید.',
          ],
        },
        {
          heading: 'مقایسه پیشنهادهای شغلی',
          paragraphs: [
            'وقتی چند پیشنهاد شغلی دارید، مقایسه فقط حقوق ناخالص کافی نیست. مزایا، بیمه تکمیلی، اضافه‌کاری و شرایط کاری همگی تأثیر مستقیم روی دریافتی نهایی دارند.',
            'پارامترهای هر پیشنهاد را به‌صورت جداگانه وارد کنید و خروجی خالص را مقایسه نمایید. این کار کمک می‌کند تصمیم دقیق‌تری بگیرید.',
          ],
        },
        {
  ...
  },
  {
    ...
    title: 'فشرده‌سازی PDF آنلاین | کاهش حجم فایل با حفظ کیفیت - رایگان',
    description:
      'کاهش حجم PDF تا ۹۰٪ با سه سطح کیفیت (بالا/متوسط/پایین). پردازش در مرورگر، فایل‌ها آپلود نمی‌شوند. بدون واترمارک، بدون ثبت‌نام.',
    keywords: [
      'فشرده‌سازی PDF',
      'کاهش حجم PDF آنلاین',
      'compress pdf free',
      'فشرده‌سازی PDF بدون واترمارک',
      'بهینه‌سازی حجم پی‌دی‌اف',
    ...
    content: {
      intro:
        'حجم فایل PDF را تا ۹۰٪ کاهش دهید با حفظ کیفیت مطلوب. سه سطح فشرده‌سازی برای نیازهای مختلف: بالا (حداکثر کیفیت)، متوسط (تعادل)، پایین (حداکثر حجم). تمام پردازش‌ها در مرورگر انجام می‌شود و فایل‌ها به سرور ارسال نمی‌شوند.',
      sections: [
        {
          heading: 'چگونه کیفیت در فشرده‌سازی حفظ می‌شود؟',
          paragraphs: [
            'فشرده‌سازی PDF با حذف داده‌های تکراری و بهینه‌سازی لایه‌های غیرضروری انجام می‌شود. متن و تصاویر اصلی حفظ می‌شوند و فقط حجم اضافی کاهش می‌یابد.',
            'در سطح «بالا»، تغییرات بسیار جزئی و غیرقابل تشخیص هستند. در سطح «پایین»، ممکن است کیفیت تصاویر کاهش یابد اما متن همچنان خوانا باقی می‌ماند.',
          ],
        },
        {
          heading: 'چه زمانی از هر سطح فشرده‌سازی استفاده کنیم؟',
          paragraphs: [
            'سطح «بالا» برای اسناد رسمی، قراردادها و فایل‌هایی که کیفیت بصری مهم است مناسب است.',
            'سطح «متوسط» برای ایمیل، چت و اشتراک‌گذاری عمومی بهترین انتخاب است.',
            'سطح «پایین» برای آپلود در سایت‌هایی با محدودیت حجم یا ذخیره‌سازی انبوه مناسب است.',
          ],
        },
      ],
      steps: [
        'فایل PDF را انتخاب کنید.',
        'سطح فشرده‌سازی (بالا/متوسط/پایین) را مشخص کنید.',
        'فایل فشرده‌شده را دانلود کنید.',
      ],
      tips: [
        'سطح فشرده‌سازی بالاتر ممکن است کیفیت تصاویر را کاهش دهد.',
        'برای اسناد متنی، تفاوت کیفیت تقریباً غیرقابل تشخیص است.',
        'فایل‌های از قبل فشرده‌شده ممکن است کاهش حجم کمتری داشته باشند.',
      ],
      faq: [
        {
          question: 'آیا متن‌ها خوانا می‌مانند؟',
          answer: 'بله، فشرده‌سازی با حفظ خوانایی متن انجام می‌شود. متن در تمام سطوح کیفیت خوانا باقی می‌ماند.',
        },
        {
          question: 'آیا فایل به سرور ارسال می‌شود؟',
          answer: 'خیر، تمام پردازش‌ها در مرورگر شما انجام می‌شود و فایل‌ها به هیچ سروری ارسال نمی‌شوند.',
        },
        {
          question: 'آیا واترمارک اضافه می‌شود؟',
          answer: 'خیر، خروجی بدون واترمارک و کاملاً رایگان است.',
        },
        {
          question: 'چه فرمت‌هایی پشتیبانی می‌شود؟',
          answer: 'فایل‌های PDF با هر اندازه و محتوایی پشتیبانی می‌شوند.',
        },
      ],
    },
  },
  ...
  },
  {
    ...
    title: 'OCR فارسی آنلاین | استخراج متن از عکس + تبدیل عکس به متن رایگان',
    description:
      'استخراج خودکار متن فارسی و انگلیسی از تصویر با OCR فارسی. پردازش ۱۰۰٪ در مرورگر، بدون آپلود فایل، رایگان و بدون ثبت‌نام.',
    keywords: [
      'OCR فارسی',
      'OCR آنلاین',
